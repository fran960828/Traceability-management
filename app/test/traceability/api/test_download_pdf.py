...
class TestTraceabilityPDF:
    ...
    def test_download_pdf_success(self, auth_client, orden_trazada_y_confirmada):
        ...
        url = reverse(
            "traceability:lot-traceability-download-pdf",
        ...
        assert (
            f'attachment; filename="Informe_Trazabilidad_{lot_number}.pdf"'
    ...
    def test_pdf_context_is_correct(self, orden_trazada_y_confirmada):
        ...
        context = {
            "content": instance.history_snapshot.get(
                "content", instance.history_snapshot
            ),
        ...
        html_content = render_to_string(
            "traceability/traceability_report.html", context
        )

...
class TestLotTraceabilitySerializer:
    ...
    def test_serializer_contains_snapshot_data(self, orden_trazada_y_confirmada):
        ...
        assert serializer.data['content']['order_details']['lot_number'] == orden_trazada_y_confirmada.lot_number

    # --- EDGE CASES ---

    def test_integrity_validation_failure_in_serializer(self, orden_trazada_y_confirmada):
        """
    ...
    def test_serializer_read_only_fields(self, orden_trazada_y_confirmada):
        ...
        serializer = LotTraceabilitySerializer(instance=trace, data=invalid_data, partial=True)

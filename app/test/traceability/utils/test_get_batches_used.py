...
class TestTraceabilityInvestigation:
    ...
    def test_get_actual_batches_used_after_confirmation(
    ...
    def test_get_actual_batches_used_multiple_materials(
        self, orden_trazada_y_confirmada
    ):
        """
    ...
    def test_get_actual_batches_used_no_stock_no_confirmation(
        self, production_order_factory
    ):
        """

import pytest
from inventory.serializers.enological_material_serializer import EnologicalMaterialSerializer
...
class TestEnologicalSerializers:
    ...
    def test_enological_unit_restriction(self, supplier):
        ...
        assert "Los productos enológicos no suelen medirse por unidades simples. Revise si debe usar KG o LITRO." in str(serializer.errors["unit_mesure"][0])

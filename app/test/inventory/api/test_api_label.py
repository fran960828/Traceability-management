...
class TestLabelAPI:
    ...
    def test_compras_can_create_but_not_delete_labels(self, api_client, user_factory, label_material, supplier):
    ...
    def test_filter_labels_by_vintage_and_type(self, auth_client, label_factory):
        ...
        response = auth_client.get(self.get_url("list"), {"vintage": 2024, "label_type": "FRONTAL"})

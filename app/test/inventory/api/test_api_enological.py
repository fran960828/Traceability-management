...
class TestEnologicalAPI:
    ...
    def test_bodeguero_can_only_view(
        self, api_client, user_factory, enological_material
    ):
    ...
    def test_enologo_can_do_everything(
        self, api_client, user_factory, enological_material
    ):
    ...
    def test_create_enological_material_success(
        self, api_client, user_factory, supplier
    ):

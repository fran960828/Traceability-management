...
class TestPurchaseOrderViewSet:
    ...
    # --- HAPPY PATH ---
    def test_enologo_can_create_order_with_items(self, auth_client, user_factory, supplier_factory, packaging_factory):
    ...
    # --- EDGE CASES & PERMISOS ---
    def test_bodeguero_cannot_delete_order(self, auth_client, user_factory, purchase_order_factory):
    ...
    def test_bodeguero_can_patch_status(self, auth_client, user_factory, purchase_order_factory):

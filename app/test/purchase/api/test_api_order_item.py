...
class TestPurchaseOrderItemViewSet:
    ...
    # --- HAPPY PATH ---
    def test_list_items_with_material_names(
        self, auth_client, purchase_order_item_factory
    ):
    ...
    def test_filter_items_by_purchase_order(
        self, auth_client, purchase_order_factory, purchase_order_item_factory
    ):
    ...
    def test_bodeguero_user_cannot_delete_item(
        self, auth_client, user_factory, purchase_order_item_factory
    ):

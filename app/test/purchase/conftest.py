...
from test.inventory.conftest import packaging_factory, label_factory,enological_factory,label_material,packaging_material,enological_material
...
@pytest.fixture
def po_completa(db, purchase_order_factory, purchase_order_item_factory, packaging_factory, enological_factory):

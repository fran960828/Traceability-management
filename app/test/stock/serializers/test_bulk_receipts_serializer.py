...
class TestBulkReceptionSerializer:
    ...
    def test_bulk_reception_happy_path_and_signal(
        self, po_completa, location_factory, rf, admin_user
    ):
            ...
            "items": [
                {
                    ...
                    "quantity": items[
                        0
                    ].quantity_ordered,  # Recibimos todo el primer item
                },
                {
    ...
    def test_bulk_reception_duplicate_batches_fails(
        self, po_completa, location_factory
    ):
    ...
    def test_bulk_reception_atomic_transaction(
        self, po_completa, location_factory, rf, admin_user
    ):
            ...
            "items": [
                {
                    "order_item": item.id,
                    "location": loc.id,
                    "batch_number": "LOTE-OK",
                    "quantity": 10,
                },
                {
                    "order_item": item.id,
                    "location": loc.id,
                    "batch_number": "LOTE-FAIL",
                    "quantity": 10000,
                },
            ]
        }

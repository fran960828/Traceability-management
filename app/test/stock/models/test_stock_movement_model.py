...
class TestStockMovementModel:
    ...
    # --- HAPPY PATH ---
    def test_movement_creation_is_successful(self, batch_con_po, location_factory, user_factory):
    ...
    # --- VALIDACIONES (CLEAN) ---
    def test_movement_zero_quantity_fails(self, batch_con_po, location_factory, user_factory):
        ...
        with pytest.raises(ValidationError, match="La cantidad del movimiento no puede ser cero"):
            mov.save()

    @pytest.mark.parametrize("m_type, qty, error_msg", [
    ...
    def test_movement_sign_consistency(self, m_type, qty, error_msg, batch_con_po, location_factory, user_factory):
    ...
    def test_movement_is_immutable(self, stock_movement_factory, user_factory):
        ...
        with pytest.raises(ValidationError, match="Los movimientos de stock son inmutables"):
            mov.notes = "Intento de fraude o corrección"
            mov.save()

    # --- TEST DE LA SIGNAL (INTEGRACIÓN) ---
    def test_signal_updates_purchase_order_flow(self, batch_con_po, location_factory, user_factory):
        """

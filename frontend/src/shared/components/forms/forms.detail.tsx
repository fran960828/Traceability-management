...
import styles from './forms.detail.module.css'; // Centralizamos tus estilos del contenedor aquí

interface GenericDetailViewProps<TData> {
  data: TData;
  badgeLabel: string;          // Ej: "Categoría: " o "Posición: "
  badgeValue: string;          // Ej: supplierData.category_name
  titleLabel: string;          // Ej: "Material: " o "Nombre: "
  titleValue: string;          // Ej: labelData.name
  codeLabel: string;           // Ej: "Código único de sistema"
  codeValue: string | number;  // Ej: labelData.internal_code
  isActive: boolean;
  fields: DetailFieldConfig[]; // El array estructurado con los mapeos y el metaCard de auditoría
